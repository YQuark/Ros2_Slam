...
report = yaml.safe_load(Path('verification/reports/hil/v0.6.0-rc2.yaml').read_text(encoding='utf-8'))
if report.get('result') != 'PASS':
    raise SystemExit('Physical HIL report is not PASS: verification/reports/hil/v0.6.0-rc2.yaml')
